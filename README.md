...
<body class="flex flex-col min-h-screen">
    ...
    <!-- COVER OVERLAY SECTION: หน้าปกปลอมเพื่อเพิ่มความน่าสนใจ -->
    <div id="cover-overlay" 
         class="fixed inset-0 z-50 flex flex-col items-center justify-center cursor-pointer transition-opacity duration-700 p-8"
         onclick="hideCover()"
         style="
            /* UPDATE: ใช้ URL รูปภาพที่ผู้ใช้ให้มา */
            background-image: url('https://i.ibb.co/6MCrdTr/Thai-Cambodia-2024-10-10.jpg'); 
            background-color: #4A3B32; /* สีพื้นหลังในกรณีที่รูปภาพโหลดไม่ขึ้น */
            background-size: cover; 
            background-position: center;
        ">
        
        <h1 class="text-4xl md:text-6xl font-extrabold text-[#F9F5F0] text-center mb-6 drop-shadow-lg"
            style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">
            มหากาพย์ความขัดแย้ง: ไทย - กัมพูชา
        </h1>
        
        <div class="text-[#D4A017] text-5xl md:text-7xl font-black text-center p-6 rounded-xl 
                    shadow-2xl bg-black bg-opacity-40 hover:bg-opacity-60 transition duration-300 
                    transform hover:scale-105 active:scale-100 ease-in-out border-4 border-[#D4A017]">
            กดเพื่ออ่าน
        </div>
        <p class="mt-8 text-lg text-[#F9F5F0] opacity-80"
           style="text-shadow: 1px 1px 2px rgba(0,0,0,0.8);">คลิกที่นี่เพื่อเข้าสู่เนื้อหาบทวิเคราะห์ทางประวัติศาสตร์</p>
    </div>
    <!-- END COVER OVERLAY SECTION -->
    ...
    <script>
        ...
        /**
         * ฟังก์ชันสำหรับซ่อนหน้าปก เมื่อผู้ใช้คลิก
         */
        function hideCover() {
            ...
            if (cover) {
                ...
                // ซ่อน element หลังจากการ transition สิ้นสุด (700ms)
                setTimeout(() => {
